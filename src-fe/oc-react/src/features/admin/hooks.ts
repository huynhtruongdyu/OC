...
export const useUserPermissions = (id: string) =>
  useQuery({
    queryKey: [...adminKeys.user(id), 'permissions'],
...
export const useUpdateUserPermissions = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      id: string;
      data: Parameters<typeof userService.updatePermissions>[1];
...
export const useUpdateRole = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      id: string;
      data: Parameters<typeof roleService.update>[1];
...
export const useRolePermissions = (id: string) =>
  useQuery({
    queryKey: [...adminKeys.role(id), 'permissions'],
...
export const useUpdateRolePermissions = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      id: string;
      data: Parameters<typeof roleService.updatePermissions>[1];
    }) => roleService.updatePermissions(id, data),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: adminKeys.roles() });
...
export const usePermissionGroups = () =>
  useQuery({
    queryKey: adminKeys.permissionGroups(),
